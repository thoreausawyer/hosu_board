        ...
        <form action="/board/boardUpdate" method="post">
	        ...
	        <div class="board-update-container">
		        <div class="board-update-title-box">
				    <label>제목 :</label> 
				    <input class="board-update-input-title" value="${board.title}"/>
		        </div>
		        ...
		        <div class="board-update-content-box">
		            <label>내용 :</label><br>
		            <textarea name="content" cols="70" rows="15" placeholder="">${board.content}</textarea> 
		        </div>
	        ...
	        <div class="board-update-button-box">
	            <button type="button" onclick="editPost(${board.num})">수정</button>
